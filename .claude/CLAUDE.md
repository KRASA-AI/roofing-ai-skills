...
You are working inside the **Roofing AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for roofers. It contains:
...
- Industry page: https://krasa.ai/industries/roofing

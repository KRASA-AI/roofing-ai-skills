...
### Legislative Activity in the Same Direction (Tracked April 2026)
A parallel track is moving through state legislatures rather than insurance departments — bills that would codify aerial-imagery limits in statute rather than rely on bulletin authority. Two patterns to watch in 2026:
...
- **Georgia — proposed maximum imagery age of 9 months.** A tighter recency window than the Kentucky bulletin and most likely a starting position for negotiation; if it advances, it would be the first state to require imagery less than a year old. Practical contractor angle: Georgia is one of the high-storm states most likely to issue a TN/KY-style bulletin in 2026 if the legislative track stalls, so contractors should track both the bill and the Department of Insurance for movement
...
- **California, Massachusetts, and other states** — California passed legislation in 2025 requiring insurer notification before aerial-imagery-based coverage decisions. Massachusetts has bills in committee that would create a homeowner right to see images and capture dates. Multi-state operators should treat the legislative track and the bulletin track as parallel and reinforcing — when one stalls in a state, the other often advances
...
- **Statutory aerial-imagery bills (Texas 12-month proposal, Georgia 9-month proposal, Massachusetts disclosure proposal)** — Parallel legislative track. If any of these enacts, the leverage on appeal letters in those states becomes substantially stronger because statutory authority is harder for carriers to dismiss than bulletin guidance. Conversely, the Florida HB 815 failure (March 13, 2026) suggests that in some states statutory reform will lag and contractors should rely on existing regulatory authority (Florida OIR memoranda) rather than wait for legislation

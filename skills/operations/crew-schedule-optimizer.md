...
Balance crew availability, weather windows, and job priority into a weekly plan.

## When to Use

Use this skill whenever you need to balance crew availability, weather windows, and job priority into a weekly plan. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled roofing professional's AI assistant. Your job is to balance crew availability, weather windows, and job priority into a weekly plan.

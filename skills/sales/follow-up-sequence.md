...
Auto-generate a multi-touch follow-up cadence for open estimates.

## When to Use

Use this skill whenever you need to auto-generate a multi-touch follow-up cadence for open estimates. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled roofing professional's AI assistant. Your job is to auto-generate a multi-touch follow-up cadence for open estimates.
